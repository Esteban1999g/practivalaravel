...
@endif
    ...
    <script>
       Swal.fire({
       icon: 'error',
       title: 'Lo siento te equivocaste',
...
@endsection
    ...
    <div class="row">
        <div class="col-sm-8 col-sm-offset-2">
            <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#crearEmpleadoModal"><i class="fas fa-user-plus"></i> Nuevo Registro</a>
        </div>
    </div>
                    ...
                    <div class="modal-content">
                        ...
                        <form>
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label for="nombre">Nombre: </label>
                                    <label>{{old('nombre', $empleado->nombre)}}</label>
                                    <small class="text-danger">{{$errors->first('nombre')}}</small>
                                </div>
                                <div class="form-group">
                                    <label for="edad">Edad: </label>
                                    <label>{{old('edad', $empleado->edad)}}</label>
                                    <small class="text-danger">{{$errors->first('edad')}}</small>
                                </div>
                                <div class="form-group">
                                    <label for="direccion">Dirección: </label>
                                    <label>{{old('direccion', $empleado->direccion)}}</label>
                                    <small class="text-danger">{{$errors->first('direccion')}}</small>

                                </div>
                                <div class="form-group">
                                    <label for="email">Email: </label>
                                    <label>{{old('email', $empleado->email)}}</label>
                                    <small class="text-danger">{{$errors->first('correo')}}</small>
                                </div>

                                <div class="form-group">
                                    <label for="cargo">Cargo: </label>
                                    <label>{{old('email', $empleado->cargoEmpleado->nombre)}}</label>
                                    <small class="text-danger">{{$errors->first('correo')}}</small>
                                </div>
                            </div>
                            <div class="modal-footer">
